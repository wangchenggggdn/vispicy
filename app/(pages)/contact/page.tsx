...
import { Mail, Send, MapPin, Clock, Github, Twitter } from 'lucide-react';
          ...
          <div className="flex justify-center max-w-5xl mx-auto">
            {contactMethods.map((method, index) => (
              <a
                key={index}
                href={method.link}
                className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition group flex items-center space-x-4"
              >
                <div className="w-12 h-12 bg-gradient-to-r from-red-100 to-orange-100 rounded-lg flex items-center justify-center group-hover:scale-110 transition flex-shrink-0">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-indigo-50 transition group"
                  >
                    <svg className="w-8 h-8 text-gray-600 group-hover:text-[#5865F2] mb-2" fill="currentColor" viewBox="0 0 24 24">
