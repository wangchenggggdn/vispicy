      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="flex items-center space-x-4 lg:space-x-6">
          <div className="hidden md:flex items-center space-x-4 lg:space-x-6">
            ...
            <Link href="/image-to-image" className="text-gray-700 hover:text-red-600 transition text-sm whitespace-nowrap">
              Image to Image
            </Link>
            <Link href="/text-to-video" className="text-gray-700 hover:text-red-600 transition text-sm whitespace-nowrap">
              Text to Video
            </Link>
          ...
          {status === 'loading' ? (
            ...
            <div className="flex items-center space-x-3">
              <Link href="/user" className="hidden sm:flex items-center space-x-2 text-gray-700 hover:text-red-600 transition text-sm cursor-pointer">
              ...
              <div className="flex items-center space-x-2">
                <Link
                  href="/coins"
                  className={`inline-flex items-center px-2 py-0.5 bg-red-100 text-red-700 rounded-full text-xs hover:bg-red-200 cursor-pointer transition ${coinsLoading ? 'opacity-50' : ''}`}
                  title="Click to purchase coins"
                >
                  {coins}
              ...
              <button
                onClick={() => signOut()}
                className="flex items-center space-x-1 text-gray-700 hover:text-red-600 transition text-sm whitespace-nowrap"
                title="Sign Out"
              >
            ...
            <button
              ...
              className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition text-sm whitespace-nowrap"
            >
              Sign In
            </button>
          )}
